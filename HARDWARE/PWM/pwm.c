...
{  
  ...
  //设置该引脚为复用输出功能,输出TIM1 CH1的PWM脉冲波形
	...
	TIM_TimeBaseStructure.TIM_Prescaler = psc; //设置用来作为TIM4时钟频率除数的预分频值  不分频
...
//	TIM_OCInitStructure.TIM_OutputState = TIM_OutputState_Enable;//比较输出使能
//	TIM_OCInitStructure.TIM_OCPolarity = TIM_OCPolarity_High;//TIM输出低
//	TIM_OC2Init(TIM4,&TIM_OCInitStructure);//根据TIM_OCInitStruct中指定的参数初始化外设TIMx
//	TIM_OC2PreloadConfig(TIM4, TIM_OCPreload_Enable);//根据TIM_OCInitStruct中指定的参数初始化外设TIMx
